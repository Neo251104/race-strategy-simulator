...
with open(r"C:\Users\Aspire\OneDrive\Desktop\Entelect Hack\2.txt") as f:
    data = json.load(f)
...
def main():
    ...
    possible_paths = [
        os.path.join(base_dir, "2.txt"),
        os.path.join(base_dir, "inputs", "2.txt"),
        r"C:\Users\Aspire\Desktop\Entelect Hack\2.txt",
        r"C:\Users\Aspire\OneDrive\Desktop\Entelect Hack\2.txt"
    ]
    ...
    if file_path is None:
        print("ERROR: Could not find 2.txt")
        print("Checked paths:")
